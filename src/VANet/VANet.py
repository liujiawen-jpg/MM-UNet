...
from src.VANet.config import config
from src.VANet.config import update_config
from src.VANet.models import build_model, QuickGELU, Block, LayerNorm
...
class VANet(nn.Module):
    def __init__(self,
        ...
        self.mask_head3 = nn.Conv2d(in_channels=embed_dims[0],
                                    ...
                                    stride=1,
                                    padding=1, )
    def upsample(self, x, target_x):
        return F.interpolate(torch.sigmoid(x), size=target_x.size()[2:], mode='bilinear', align_corners=True)
...
if __name__ == "__main__":
    ...
    model = VANet(in_chans=3,
                  act_layer=QuickGELU,
                  cfg='/workspace/Jeming/ES/src/VANet/experiments/imagenet/cvt/cvt-13-224x224.yaml',
