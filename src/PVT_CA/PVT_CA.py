...
class PVT_CASCADE(nn.Module):
    def __init__(self, n_class=1, o_class=1, model_dir='/workspace/Encs/src/CVCUNETR/pvt_v2_b2.pth'):
        ...
        self.backbone = pvt_v2_b2(in_chans=n_class,embed_dims=[64, 128, 320, 512])
        ...
        self.out_head1 = nn.Conv2d(512, o_class, 1)
        self.out_head2 = nn.Conv2d(320, o_class, 1)
        self.out_head3 = nn.Conv2d(128, o_class, 1)
        self.out_head4 = nn.Conv2d(64, o_class, 1)
...
if __name__ == '__main__':
    device = 'cpu'
    model = PVT_CASCADE(n_class=3, o_class=1).to(device)
